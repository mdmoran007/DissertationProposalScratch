...
#   - WordNet (via NLTK)
#   - Fasttext (via Gensim Word2Vec) - 1M vectors. 16B tokens. 300-d vectors
#   - GloVe (via Gensim Word2Vec) - 400K vectors off of 6B tokens. 300-d vectors
#   - GoogleNews (via Gensim Word2Vec) - 100B words. 300-d vectors for about 3M words and phrases
#   - ConceptNet Numberbatch (via Gensim Word2Vec) - AAAI paper. 300-d. 1.9M vectors
# Mark Moran, markdm2@illinois.edu
# November 12, 2021
# ---------------------------------------------------------------------------------------------------
# In version 1.1, I am improving documentation, and asking the libraries to find synonyms for all of my synonyms
# This will become the new H0 in my paper.
